...
### Key Highlights:
- **CTO & Lead Developer at [Explora Prado](https://exploraprado.com)**: Built a self-guided digital experience for Museo del Prado from scratch using Flutter. Recipient of the *Art-Tech 2025 Honorable Mention* and selected for *Santander X Explorer 2026*.
...
### Ecosystem & Cloud
- **Cloud/SDKs:** Firebase Suite (Auth, Firestore, App Check, Crashlytics), Google Ads SDK, Amplitude, CleverTap
