...
[![Email](https://img.shields.io/badge/Email-Contact-red?style=for-the-badge&logo=gmail)](mailto:david@ruizurraca.com)
...
### Core & Frameworks
- **Languages:** Kotlin, Dart, Java, TypeScript (familiar), JavaScript (familiar), XML, SQL
...
- **KMP & Cross-platform:** Kotlin Multiplatform (KMP), shared domain/data layer, Compose Multiplatform, SwiftUI (native iOS), SQLDelight, Ktor Multiplatform, React Native + JavaScript/TypeScript (familiar — a platform on-ramp rather than a primary stack; app architecture experience plus an AI-assisted workflow make React Native projects approachable)
...
*   **B.Sc. in Computer Science (Information Systems Management)**
    *   *Universidad de La Rioja (Spain)*
    *   Final Year Project implemented on Android (Grade: 9/10).
...
-   **Styling:** Custom CSS3 with dynamic CSS variables, animated ambient background orbs, glassmorphic elements, and customized hover effects.
-   **Logic:** Vanilla JS for scrolling animations, dynamic elements, page loading states, email copy-to-clipboard functionality, and interactive section toggles.
-   **Design:** Tailored for a premium dark mode layout using modern fonts (*Space Grotesk* and *Plus Jakarta Sans*).

---

## 📬 Contact & Connect

Feel free to connect or reach out regarding mobile architecture, contract opportunities, or AI agent integration projects:

-   **Email:** [david@ruizurraca.com](mailto:david@ruizurraca.com)
-   **Phone:** [+34 644 627 262](tel:+34644627262)
-   **LinkedIn:** [linkedin.com/in/davidru85](https://linkedin.com/in/davidru85)
-   **GitHub:** [github.com/davidru85](https://github.com/davidru85)
